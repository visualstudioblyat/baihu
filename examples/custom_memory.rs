//! Example: Implementing a custom Memory backend for Baihu
//!
...
// ── Re-define the trait types (in your app, import from baihu::memory) ──
...
async fn main() -> anyhow::Result<()> {
    ...
    println!("🧠 Baihu Memory Demo — InMemoryBackend\n");
